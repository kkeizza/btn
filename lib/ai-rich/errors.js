// errors.js
// Error classes for AIRich's id-based content addressing (assignId, peek,
// replace, insertAt, delete). Part of the NIXCODE-derived AIRich builder --
// see airich.js for the full watermark/license text.
