// toolkit.js
// Media/formatting helpers used by AIRich: resizing, URL/buffer resolution
// (uploading to WhatsApp via standard `prepareWAMessageMedia` +
// `sock.waUploadToServer`), MP4 metadata parsing, and JSON escaping. Part of
// the NIXCODE-derived AIRich builder -- see airich.js for the full
